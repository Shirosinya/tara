                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="ecommerce" data-parent="#accordionExample">
                            <li>
                                <a href="ecommerce_dashboard.html"> Suku Cadang </a>
                            </li>
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="jasa">
                                    ...
                                    <li>
                                        <a href="ecommerce_product_details_2.html"> Jasa Tenaga Kerja Alih Daya </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="sewa">
                                    <li>
                                        <a href="ecommerce_product_details_1.html"> Sewa Peralatan Pabrik & Kantor </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
