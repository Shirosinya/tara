            ...
            <div class="col-md-2">
                <div class="form-group">
                    <input type="button" class="btn btn-info btn-sm" placeholder="Submit" value = "filter"
                        onClick="javascript: window.location.href = '/jasaaudit/yearpicker=' + document.getElementById('yearpicker').value;">
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('mengajukan') }}" method="POST">
                                                                ...
                                                                <input type="hidden" class="form-control" name="id_tipe_akun" value="3">
                                                                <!-- <div class="form-group mb-4">
